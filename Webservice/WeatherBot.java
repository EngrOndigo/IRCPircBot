...
public class WeatherBot extends PircBot {
    ...
    // IRC channel to join
    //static final String channel = "JashConnect";
    static final String channel = "#pircbot";
    ...
    public void onMessage(String channel, String sender, String login, String hostname, String message) {
        ...
        if (message.contains("weather")) {
            // If unable to determine location, use default location
            ...
            // The message is longer than 2 words (e.g. a sentence)
                ...
                if (matcher.find()) {
                    ...
                    sendMessage(channel, "Unable to determine location.");
                }
            }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            bot.sendMessage(channel, "Joe Samuel.");
        }
    }
